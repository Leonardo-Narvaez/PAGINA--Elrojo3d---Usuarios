                                                                                                                            ...
                                                                                                                            ('Rojo', '#ff3131', true, 2),
                                                                                                                                ('Amarillo', '#ffd400', true, 3),
                                                                                                                                    ('Blanco', '#f5f5f5', true, 4),
                                                                                                                                        ...
                                                                                                                                        -- SESIONES ACTIVAS (una sola sesión por usuario) -----------------
                                                                                                                                        create table if not exists public.sesiones_activas (
                                                                                                                                            user_id uuid primary key references auth.users(id) on delete cascade,
                                                                                                                                                token text not null,
                                                                                                                                                    ...
                                                                                                                                                    -- cada usuario gestiona únicamente su propia sesión
                                                                                                                                                    ...
                                                                                                                                                    -- IMPORTANTE (seguridad): desactiva el registro público en
                                                                                                                                                    -- Supabase Dashboard > Authentication > Providers > Email
                                                                                                                                                    -- ("Allow new users to sign up" = OFF). El usuario admin se crea
                                                                                                                                                    -- manualmente en Authentication > Users > Add user.
